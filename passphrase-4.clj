...
(def input (string/split-lines "una bokpr ftz ryw nau yknf fguaczl anu
...
(def check-valid? (partial check valid?))

(when true
  (check-valid? true "aa bb cc dd ee")
  (check-valid? false "aa bb cc dd aa")
  (check-valid? true "aa bb cc dd aaa")
  (check count "?" (filter valid? input)))
